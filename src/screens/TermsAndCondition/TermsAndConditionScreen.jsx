...
const TermsAndConditionScreen = () => (
  <Container className="mt-4">
    ...
    <p>Welcome to SaveABuiz!</p>

    <p>
      These terms and conditions outline the rules and regulations for the use of SaveABuiz&apos;s
      Website, located at saveabuiz.me.
    </p>

    <p>
      By accessing this website we assume you accept these terms and conditions. Do not continue to
      use SaveABuiz if you do not agree to take all of the terms and conditions stated on this page.
    </p>
    ...
    <p>
      We employ the use of cookies. By accessing SaveABuiz, you agreed to use cookies in agreement
      with the SaveABuiz&apos;s Privacy Policy.{' '}
    </p>
    ...
    <p>
      Unless otherwise stated, SaveABuiz and/or its licensors own the intellectual property rights
      for all material on SaveABuiz. All intellectual property rights are reserved. You may access
      this from SaveABuiz for your own personal use subjected to restrictions set in these terms and
      conditions.
    </p>

    <p>You must not:</p>
    <ul>
      <li>Republish material from SaveABuiz</li>
      <li>Sell, rent or sub-license material from SaveABuiz</li>
      <li>Reproduce, duplicate or copy material from SaveABuiz</li>
      <li>Redistribute content from SaveABuiz</li>
    </ul>
    ...
    <p>
      ...
      information in certain areas of the website. SaveABuiz does not filter, edit, publish or
      review Comments prior to their presence on the website. Comments do not reflect the views and
      opinions of SaveABuiz,its agents and/or affiliates. Comments reflect the views and opinions of
      the person who post their views and opinions. To the extent permitted by applicable laws,
      SaveABuiz shall not be liable for the Comments or for any liability, damages or expenses
      caused and/or suffered as a result of any use of and/or posting of and/or appearance of the
      Comments on this website.
    </p>

    <p>
      SaveABuiz reserves the right to monitor all Comments and to remove any Comments which can be
    ...
    <p>
      You hereby grant SaveABuiz a non-exclusive license to use, reproduce, edit and authorize
    ...
    <p>
      ...
      visibility of the hyperlink compensates the absence of SaveABuiz; and (d) the link is in the
    ...
    <p>
      ...
      to our website, you must inform us by sending an e-mail to SaveABuiz. Please include your
    ...
    <p>
      No use of SaveABuiz&apos;s logo or other artwork will be allowed for linking absent a
