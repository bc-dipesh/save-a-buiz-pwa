...
const PrivacyPolicyScreen = () => (
  <Container className="mt-4">
    <h1 className="mb-4">Privacy Policy for SaveABuiz</h1>

    <p>
      At SaveABuiz, accessible from saveabuiz.me, one of our main priorities is the privacy of our
      visitors. This Privacy Policy document contains types of information that is collected and
      recorded by SaveABuiz and how we use it.
    </p>
    ...
    <p>
      ...
      website with regards to the information that they shared and/or collect in SaveABuiz. This
    ...
    <p>
      SaveABuiz follows a standard procedure of using log files. These files log visitors when they
    ...
    <p>
      ...
      Beacons that are used in their respective advertisements and links that appear on SaveABuiz,
    ...
    <p>
      Note that SaveABuiz has no access to or control over these cookies that are used by
    ...
    <p>
      SaveABuiz&apos;s Privacy Policy does not apply to other advertisers or websites. Thus, we are
    ...
    <p>
      SaveABuiz does not knowingly collect any Personal Identifiable Information from children under
