...
const StartFundraiserScreen = ({ history }) => {
	...
	const { loading, error, fundraiser } = useSelector(
		(state) => state.fundraiserCreate
	);
			...
			<Row>
				...
				<Form onSubmit={submitCreateFundraiserForm}>
					...
					<Form.Group controlId="fundraisingGoal" className="mb-4">
						...
						/>
						<Form.Text className="text-muted">
							Keep in mind that transaction fees, including credit
							and debit charges, are deducted from each donation.
							<br />
							...
							You can always change your goal amount later. If
							you&apos;re not sure where to start, start with the
							minimum goal that can get your business back to
							working state.
						</Form.Text>
					</Form.Group>
					<Form.Group
						controlId="fundraisingCoverPhoto"
						className="mb-4"
					>
					...
					<Form.Group
						controlId="fundraisingYouTubeVideoLink"
						className="mb-4"
					>
						<InputGroup>
							<InputGroup.Prepend>
					...
					<Form.Group
						controlId="fundraisingDescription"
						className="mb-4"
					>
						...
						/>
						<Form.Text className="text-muted">
							Explain about your business, who you are and why
							you&apos;re fundraising.
							<br />
							To raise the most money for a campaign, make sure
							you:
							<ul>
					...
					<Form.Group>
						<Form.Text className="text-muted">
							By submitting this form, you agree to the SaveABuiz
