...
const UserProfileScreen = ({ history }) => {
  ...
  useEffect(() => {
    ...
    if (error || profileUpdateError || passwordUpdateError) {
      displaySnackbar(error || profileUpdateError || passwordUpdateError, 'error');
    }
  }, [
    history,
    userInfo,
      ...
      <Row>
        <Col xs={12} sm={7}>
          ...
          >
            <Form.Group controlId="name">
              ...
              {loading ? (
                ...
                <Form.Control
                  ...
                  isInvalid={!!updateUserProfileErrors.name?.message}
                />
              )}
            ...
            <Form.Group controlId="email" className="my-3">
              ...
              {loading ? (
                ...
                <Alert variant="info">
                  ...
                  We&apos;ve sent you a email verification link to the email address you provided.
                  Please verify your email then logout and sign in again after email verification.
                </Alert>
              ) : (
                <Form.Control
                  type="email"
                  ...
                  isInvalid={!!updateUserProfileErrors.email?.message}
                />
              )}
              <Form.Control.Feedback type="invalid">
            ...
            <Form.Group controlId="mobilePhoneNumber" className="my-3">
              ...
              {loading ? (
                ...
                <Form.Control
                  ...
                  {...registerUpdateUserProfile('mobilePhoneNumber')}
                  isInvalid={!!updateUserProfileErrors.mobilePhoneNumber?.message}
                />
              )}
              <Form.Control.Feedback type="invalid">
            ...
            <Button className="mt-5" type="submit" variant="outline-primary">
