...
import useTopThreeFundraiser from '../../hooks/useTopThreeFundraiser';
import { reloadPage } from '../../utils/commonFunctions';

const Children = React.memo(() => {
  const { loading, error, fundraisers } = useTopThreeFundraiser();
      ...
      return (
        <Container>
          <Message title="No Fundraisers" variant="info">
            There are no fundraisers to calculate top three fundraisers.
          </Message>
    ...
    <Container className="mt-5">
      <Row className="justify-content-center">
        <h1 className="mb-3 h2">
          ...
          Top Three Fundraisers With Most Donations
        </h1>
        <Children />
      </Row>
    </Container>
    ...
    <Container style={{ backgroundColor: '#fbf8f6' }} fluid>
      <Container>
        <Row className="my-5 py-5">
          <h2 className="py-3">The leader in online fundraising</h2>
          <Row>
            <Col className="p-3" xs={12} sm={4}>
              <h3 className="py-3 h4">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
              ...
              <p>
                SaveABuiz is trusted around the world for its simple, reliable fundraising platform.
              </p>
            </Col>
            <Col className="p-3" xs={12} sm={4}>
              <h3 className="py-3 h4">
              ...
              <p>You can personalize and share your SaveABuiz in just a few minutes.</p>
            </Col>
            <Col className="p-3" xs={12} sm={4}>
              <h3 className="py-3 h4">
                <svg
          ...
          <Row>
            <Col className="p-3" xs={12} sm={4}>
              ...
              <p>
                SaveABuiz is a Progressive Web App that makes it simple to launch and manage your
            ...
            <Col className="p-3" xs={12} sm={4}>
              ...
              <p>
                Our best-in-class Customer Happiness agents will answer your questions, day or
                night.
              </p>
            </Col>
          </Row>
          <Col>
            <LinkContainer to="/start-fundraiser">
              <Button variant="outline-primary">Start a SaveABuiz</Button>
            </LinkContainer>
          </Col>
        </Row>
      </Container>
