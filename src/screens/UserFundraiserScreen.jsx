		...
		return (
			<Row>
				{fundraisers.map((fundraiser) => {
					...
					const fundraiserCreatedAt =
						differenceFromCurrentDate(createdAt);
					return (
						<Col className="my-3" sm={12} md={4} lg={3} key={_id}>
							<Card>
								...
								<Card.Footer>
									<small>
										Created
										{fundraiserCreatedAt === 0
											? ' Today at '
											: ` ${fundraiserCreatedAt} days ago at `}
										{`${new Date(
											createdAt
										).toLocaleTimeString()}`}
									</small>
